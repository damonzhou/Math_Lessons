...
- Review 顺序从 **R0 主线定位 → R0.5 教材映射** 开始，并新增 **R3.5 最高深度与能力上限诊断**，同时包含 **R11 Markdown / LaTeX 渲染稳健性**；
- 每讲必须覆盖五层：教材完整、概念深度、校内高阶、竞赛/信息学迁移、Ceiling Diagnostic；
...
- 每讲 provenance 必须区分“实际采用来源”和“候选权威题源池审查”，并说明哪一道题承担 Ceiling Diagnostic；
...
6. Mainline Lesson 标记“最高深度覆盖完成”前必须通过 R0、R0.5、R1～R3、R3.5、R4～R11 完整 Release Review；
7. Lesson 1～4 原 PASS 仍保留历史意义，但需额外完成 v1.9 上限诊断兼容审计。
