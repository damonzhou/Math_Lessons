...
当前规范由 **v1.3～v1.9 + v2.0 + v2.1 + v2.2** 共同组成：

- [v2.2｜2026-09-05](./course-standard-v2.2.md) — **当前增量标准**；思维深度优先于计算难度、D1～D6、R3.7 思维深度门禁
- [v2.1｜2026-09-05](./course-standard-v2.1.md) — 题目级官方原题/解答链接、SYNTHESIS 结构来源、R7.5 可追溯性门禁
...
不把以下内容单独当作深度证据：数字更大、运算更长、题量更多、步骤更多、赛事等级更高或提前使用后续公式。

从 Lesson 7 起，Mainline 每讲完整课程至少覆盖 D1～D6 中四类，并至少有一处要求证明答案的唯一性、穷尽性或分类完整性。
...
Lesson 1～4 已完成 v2.0 迁移；Lesson 5～6 从首次建设即原生包含 Ceiling Diagnostic、Ceiling Builder、T0/T1/T2。

v2.1 的题目级原题链接正在对已有来源题回填。

v2.2 对 Lesson 3～6 采用“缺口驱动补强”：已有思维深度足够的部分不机械加题，只在 R3.7 审查发现真实缺口时调整。
...
只有 R3.5、R3.6、R3.7、R7.5 都通过，且其余 Release Review 项通过，才能标记课程发布完成。
